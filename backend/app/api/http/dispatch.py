...
def _pick_primary_message(messages: list[dict]) -> dict:
    ...
    priority = (
        ...
        MessageType.JOURNAL_ENTRY,
        MessageType.JOURNAL_DELETED,
        MessageType.CHART_DRAWINGS,
        MessageType.ML_JOB_PROGRESS,
        MessageType.TICKS_UPDATE,
        MessageType.COPILOT_AGENT_MESSAGE,
